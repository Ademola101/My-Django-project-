...
urlpatterns = [
    ...
    path("<str:name>/topics/<str:topic_subject>/reply", views.reply_topic, name="reply_topic"),
    path("<str:name>/topics/<str:topic_subject>/posts/<int:post_name>/edit/",views.PostUpdateView.as_view(), name = "edit_post"),
